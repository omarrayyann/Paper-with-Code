...
def train(model, epochs, train_loader, test_loader, criterion, optimizer, RESULTS_PATH, scheduler=None, MODEL_PATH):
  ...
  for epoch in range(epochs):
    ...
    results_df.loc[epoch] = [loss.item(), train_err, test_err]
